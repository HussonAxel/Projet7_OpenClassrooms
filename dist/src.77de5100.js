...
},{}],"components/RecipeComponent.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
function getRecipeTemplate(recipeID, recipeTime, recipePicture) {
  return "\n      <div>\n        <img src=\"".concat(recipePicture, "\" alt=\"\" class=\"w-full h-[253px] rounded-md\" />\n        <span id=\"recipeTime\">\"").concat(recipeTime, "\"</span>\n      </div>\n      <div class=\"mx-6\">\n        <h2 id=\"recipeName\" class=\"font-Anton text-lg my-7\"></h2>\n        <div class=\"font-Manrope mb-7\">\n          <p class=\"uppercase font-bold text-xs text-grey my-2\">Recette</p>\n          <p id=\"recipeSteps\"></p>\n        </div>\n        <div>\n          <p class=\"uppercase font-bold text-xs text-grey my-2\">Ingr\xE9dients</p>\n          <div class=\"pb-16\">\n          </div>\n        </div>\n      </div>\n  ");
}
exports.default = getRecipeTemplate;
...
var RecipeComponent_1 = __importDefault(require("./components/RecipeComponent"));
// VARIABLES DECLARATIONS
var sectionRecipes = document.getElementById("sectionRecipes"),
  recipeClasses = "bg-white max-w-sm w-full max-h-3xl h-full rounded-md";
function getRecipes(recipesData) {
  addRecipes();
}
function addRecipes() {
  data_json_1.default.forEach(function (element) {
    var recipeArticle = document.createElement("article"),
      recipePicture = "./assets/recipesPictures/Recette".concat(element.id, ".jpg");
    recipeArticle.className = recipeClasses;
    recipeArticle.innerHTML = (0, RecipeComponent_1.default)(element.id, element.time, recipePicture);
    sectionRecipes.append(recipeArticle);
  });
}
getRecipes(data_json_1.default);
},{"./data/data.json":"data/data.json","./components/RecipeComponent":"components/RecipeComponent.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
